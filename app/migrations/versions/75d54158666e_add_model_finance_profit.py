"""add model finance profit

Revision ID: 75d54158666e
Revises: 
Create Date: 2024-05-13 18:27:01.454221
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
            ...
            sa.Column('all_profits', sa.Integer(), nullable=True),
            sa.Column('all_losses', sa.Integer(), nullable=True),
            sa.Column('all_tax', sa.Integer(), nullable=True),
            sa.PrimaryKeyConstraint('id')
    )
    op.create_table('profit',
    sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('profit', sa.Integer(), nullable=False),
            sa.Column('name_profit', sa.String(), nullable=False),
            sa.Column('description_profit', sa.String(), nullable=True),
            sa.PrimaryKeyConstraint('id')
    )
